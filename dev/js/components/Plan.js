    ...
    render() {
        ...
        return(
            <div className="rt-plan"> 
                ...
                <input type="radio" id="planA" name="plans" onClick={this.handleChange.bind(this,"Plan A")}/>
                <label htmlFor="planA">Plan A</label> 
                <input type="radio" id="planB" name="plans" onClick={this.handleChange.bind(this,"Plan B")}/>
